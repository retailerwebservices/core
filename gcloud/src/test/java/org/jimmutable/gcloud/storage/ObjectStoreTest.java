...
//			objStore.createBlob("MyBlobTextName","This is my test blob data of type text.");
//			objStore.deleteBlob("MyBlobTextName");
			objStore.uploadFileToBlob("/Users/preston/SampleDataForGAE.pdf", test_object_name, "application/pdf");
			objStore.uploadAndCompressFileToBlob("/Users/preston/SampleDataForGAE.pdf", test_object_name_comp, "application/pdf");
			objStore.uploadAndCompressStringToBlob("Test Compressed Text file", "text/plain","This is test data. It could be XML, JSON, etc.");
...
//			objStore.listBlobsInBucket(true);
			...
			Blob blob = objStore.getBlobWithGeneration("Test HTML data", 1503012230217709L);
			assert (true);
		} catch (Exception e)
		{
			assert (false);
