...
public class BuilderTest extends TestCase
{
	...
	{
		static public final TypeName TYPE_NAME = new TypeName("jimmutable.test.BuilderTestObject"); public TypeName getTypeName() { return TYPE_NAME; }
		...
		public void freeze() { my_list_of_strings.freeze(); }
