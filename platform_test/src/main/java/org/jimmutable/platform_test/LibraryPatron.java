...
/**
 * This is the class we use to manage our library patrons. This class pertains
 * all information related to a patron and all information that would be
 * necessary to manage their interactions with a library.
 * 
 * @author andrew.towe
 *
 */
