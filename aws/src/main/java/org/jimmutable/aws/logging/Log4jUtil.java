...
public class Log4jUtil
{
	...
	// private static Map<java.util.logging.Level, org.apache.logging.log4j.Level>
	// level_jul_log4j;
	//
	// static {
	//
	...
	//
	// level_jul_log4j = new HashMap<java.util.logging.Level,
	// org.apache.logging.log4j.Level>();
	//
	// level_jul_log4j.put(java.util.logging.Level.FINEST,
	// org.apache.logging.log4j.Level.TRACE);
	// level_jul_log4j.put(java.util.logging.Level.FINER,
	// org.apache.logging.log4j.Level.DEBUG);
	// level_jul_log4j.put(java.util.logging.Level.FINE,
	// org.apache.logging.log4j.Level.DEBUG);
	// level_jul_log4j.put(java.util.logging.Level.CONFIG,
	// org.apache.logging.log4j.Level.INFO);
	// level_jul_log4j.put(java.util.logging.Level.INFO,
	// org.apache.logging.log4j.Level.INFO);
	// level_jul_log4j.put(java.util.logging.Level.WARNING,
	// org.apache.logging.log4j.Level.WARN);
	// level_jul_log4j.put(java.util.logging.Level.SEVERE,
	// org.apache.logging.log4j.Level.ERROR);
	// level_jul_log4j.put(java.util.logging.Level.OFF,
	// org.apache.logging.log4j.Level.OFF);
	// level_jul_log4j.put(java.util.logging.Level.ALL,
	...
	public static void setAllLoggerLevels(Level level)
	{
		...
		// String path = String.format("%s%s%s", System.getProperty("user.home"),
		// File.separator, "log4j2.properties");
		//
		// System.out.println(String.format("log4j path: %s", path));

		// TODO if we ever want to spend time to programmatically setup this
		...
		// throw new RuntimeException(String.format("No log4j Level mapping exists for
		// JUL Level %s", level));
		// }
		...
		conf.getLoggers().forEach((k, v) -> {
			System.out.println(String.format("Logger name: ", k));
