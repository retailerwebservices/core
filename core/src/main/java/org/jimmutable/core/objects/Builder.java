...
public class Builder
{
	...
	public void set( FieldDefinition.Boolean field, boolean value )
	{
		insertNonNullPrimative(field, Boolean.toString(value), true);
	}

	public void set( FieldDefinition.Character field, char value )
	{
		insertNonNullPrimative(field, Character.toString(value), true);
	}

	public void set( FieldDefinition.Byte field, byte value )
	{
		insertNonNullPrimative(field, Byte.toString(value), true);
	}

	public void set( FieldDefinition.Short field, short value )
	{
		insertNonNullPrimative(field, Short.toString(value), true);
	}

	public void set( FieldDefinition.Integer field, int value )
	{
		insertNonNullPrimative(field, Integer.toString(value), true);
	}

	public void set( FieldDefinition.Long field, long value )
	{
		insertNonNullPrimative(field, Long.toString(value), true);
	}

	public void set( FieldDefinition.Float field, float value )
	{
		insertNonNullPrimative(field, Float.toString(value), true);
	}

	public void set( FieldDefinition.Double field, double value )
	{
		insertNonNullPrimative(field, Double.toString(value), true);
	}
	...
	public <U extends StandardObject> U createSilent( U default_value )
	{
		...
		try
		{
			object = (U) under_construction.asObject(default_value);
		}
		catch ( Exception e )
		{
	...
	public void add( FieldDefinition.Collection field, boolean value )
	{
		insertNonNullPrimative(field, Boolean.toString(value), false);
	}

	public void add( FieldDefinition.Collection field, char value )
	{
		insertNonNullPrimative(field, Character.toString(value), false);
	}

	public void add( FieldDefinition.Collection field, byte value )
	{
		insertNonNullPrimative(field, Byte.toString(value), false);
	}

	public void add( FieldDefinition.Collection field, short value )
	{
		insertNonNullPrimative(field, Short.toString(value), false);
	}

	public void add( FieldDefinition.Collection field, int value )
	{
		insertNonNullPrimative(field, Integer.toString(value), false);
	}

	public void add( FieldDefinition.Collection field, long value )
	{
		insertNonNullPrimative(field, Long.toString(value), false);
	}

	public void add( FieldDefinition.Collection field, float value )
	{
		insertNonNullPrimative(field, Float.toString(value), false);
	}

	public void add( FieldDefinition.Collection field, double value )
	{
		insertNonNullPrimative(field, Double.toString(value), false);
	}
	...
	private ObjectParseTree mapKeyOrValueToObjectParseTree( FieldName field_name, Object value )
	{
		...
		if ( value instanceof Character )
			primative_value = value.toString();
		...
		if ( value instanceof String )
			primative_value = (String) value;
		if ( value instanceof Stringable )
			primative_value = ((Stringable) value).getSimpleValue();
