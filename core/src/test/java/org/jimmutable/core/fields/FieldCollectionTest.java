...
public class FieldCollectionTest extends TestCase
{
	...
	{
		static public final TypeName TYPE_NAME = new TypeName("jimmutable.test.field_collection.dummy_object");
		...
		public TestObject( Class field_class )
		{
			...
			if ( collection instanceof List )
				old_list_iterator = ((List) collection).listIterator();
		...
		public FieldCollection<String> getSimpleCollection()
		{
			return collection;
		}
		...
		public boolean equals( Object obj )
		{
			...
			if ( !getSimpleCollection().equals(other.getSimpleCollection()) )
				return false;
