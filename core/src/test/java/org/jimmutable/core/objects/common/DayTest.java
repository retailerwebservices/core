...
public class DayTest extends TestCase {
	...
	public void testValidDayTrevorBirthday() {
		Day day = new Day("01/24/1990");
		
		//assertEquals(day.getSimpleValue(), "1/24/1990");

		assertEquals(1990, day.getSimpleYear());
		assertEquals(1, day.getSimpleMonthOfYear());
		assertEquals(24, day.getSimpleDayOfMonth());

		assertEquals("Wednesday", day.getSimpleDayName());
		assertEquals("Wed", day.getSimpleThreeLetterDayName());

		assertEquals("January", day.getSimpleMonthName());
		assertEquals("Jan", day.getSimpleThreeLetterMonthName());
	}
