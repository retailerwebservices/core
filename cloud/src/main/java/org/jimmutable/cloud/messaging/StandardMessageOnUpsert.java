...
public class StandardMessageOnUpsert extends StandardImmutableObject<StandardMessageOnUpsert> 
{
	...
	static public final FieldDefinition.Stringable<Kind> FIELD_KIND = new FieldDefinition.Stringable("kind",null, Kind.CONVERTER);
	static public final FieldDefinition.Stringable<ObjectId> FIELD_OBJECT_ID = new FieldDefinition.Stringable("object_id",null, ObjectId.CONVERTER);
	...
	public ObjectId getSimpleObjectId() { return object_id; }
	...
	public void validate() { Validator.notNull(kind, object_id);	}
	...
	{
		if ( !(obj instanceof StandardMessageOnUpsert) ) return false;
