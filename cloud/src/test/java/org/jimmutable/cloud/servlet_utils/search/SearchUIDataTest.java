...
public class SearchUIDataTest extends StubTest
{
	...
	// List<AdvancedSearchField> search_field = Collections.singletonList(new
	// AdvancedSearchField("Label", new SearchFieldId("SearchFieldId"),
	// AdvancedSearchFieldType.TEXT, Collections.emptyList()));
	// List<IncludeFieldInView> fields_in_view = Collections.singletonList(new
	// IncludeFieldInView("fieldLabel", new SearchFieldId("SearchFieldId"), false));
