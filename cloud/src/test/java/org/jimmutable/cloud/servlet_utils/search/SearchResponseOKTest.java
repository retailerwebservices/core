...
public class SearchResponseOKTest extends StubTest
{
	...
	{
//		SearchResponseOKOLD result = null;
//		
...
//		try
//		{
//			result = new SearchResponseOKOLD(search_request, search_result_list, 1, true,
//					true, 20, 1, 1l);
//
...
//		assertTrue(result.getSimpleHTTPResponseCode() == SearchResponseOKOLD.HTTP_STATUS_CODE_OK);
...
//		try
//		{
//			result = new SearchResponseOKOLD(new StandardSearchRequest(""), new ArrayList<OneSearchResult>(), 0, false, false, 0, 0, 1l);
//		} catch (Exception e)
//		{
//			fail();
//		}
...
//			);
//		
//		SearchResponseOKOLD obj = (SearchResponseOKOLD) StandardObject.deserialize(obj_string);
...
//		assertTrue(obj.getSimpleHTTPResponseCode() == SearchResponseOKOLD.HTTP_STATUS_CODE_OK);
