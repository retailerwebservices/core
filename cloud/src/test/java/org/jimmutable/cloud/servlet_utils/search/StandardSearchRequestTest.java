...
public class StandardSearchRequestTest extends StubTest
{
	...
	{
		String obj_string = String.format("%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s", "{", "  \"type_hint\" : \"jimmutable.aws.servlet_utils.search.StandardSearchRequest\",", "  \"query\" : \"Test Query\",", "  \"max_results\" : 50,", "  \"start_results_after\" : 20,", "  \"sort\" : {", "    \"type_hint\" : \"org.jimmutable.cloud.servlet_utils.search.Sort\",", "    \"sort_order\" : [ {", "      \"type_hint\" : \"org.jimmutable.cloud.servlet_utils.search.SortBy\",", "      \"field\" : {", "        \"type_hint\" : \"org.jimmutable.cloud.elasticsearch.SearchIndexFieldDefinition\",", "        \"name\" : {", "          \"type_hint\" : \"jimmutable.FieldName\",", "          \"name\" : \"field\"", "        },", "        \"type\" : \"keyword\"", "      },", "      \"direction\" : \"descending\"", "    } ]", "  }", "}");
