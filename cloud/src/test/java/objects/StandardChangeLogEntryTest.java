...
public class StandardChangeLogEntryTest extends StubTest
{
	...
	public void serializationNulls()
	{
		...
		String obj_string = String.format("%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s", "{", "  \"type_hint\" : \"change_log_entry\",", "  \"id\" : \"0000-0000-0000-0000\",", "  \"subject\" : \"thing:0000-0000-0000-0000\",", "  \"timestamp\" : 0,", "  \"changemadebyuserid\" : \"0000-0000-0000-0001\",", "  \"short_description\" : \"Short\",", "  \"attachments\" : [ ]", "}");
